...
namespace MyBGList.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        [HttpPut(Name = "Seed")]
        [ResponseCache(NoStore = true)] //disabled the cache
        public async Task<IActionResult> Put()
        {
            ...
            // Solve the erro that we’re trying to assign an explicit value taken from the CSV record to the Id property manually instead of accepting the default value and having the database handle it. 
